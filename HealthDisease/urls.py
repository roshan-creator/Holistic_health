"""HealthDisease URL Configuration
...
from healthapp.views import nutrition_details
...
urlpatterns = [
    ...
    path('add_generalhealth', add_generalhealth, name="add_generalhealth"),
    ...
    path('nutrition_details/', nutrition_details, name="nutrition_details"),
